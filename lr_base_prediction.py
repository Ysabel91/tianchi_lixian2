...
# data_set features
path_df_part_1_U = "./data/feature/df_part_1_U.csv"
path_df_part_1_I = "./data/feature/df_part_1_I.csv"
path_df_part_1_C = "./data/feature/df_part_1_C.csv"
path_df_part_1_IC = "./data/feature/df_part_1_IC.csv"
path_df_part_1_UI = "./data/feature/df_part_1_UI.csv"
path_df_part_1_UC = "./data/feature/df_part_1_UC.csv"

path_df_part_2_U = "./data/feature/df_part_2_U.csv"
path_df_part_2_I = "./data/feature/df_part_2_I.csv"
path_df_part_2_C = "./data/feature/df_part_2_C.csv"
path_df_part_2_IC = "./data/feature/df_part_2_IC.csv"
path_df_part_2_UI = "./data/feature/df_part_2_UI.csv"
path_df_part_2_UC = "./data/feature/df_part_2_UC.csv"

path_df_part_3_U = "./data/feature/df_part_3_U.csv"
path_df_part_3_I = "./data/feature/df_part_3_I.csv"
path_df_part_3_C = "./data/feature/df_part_3_C.csv"
path_df_part_3_IC = "./data/feature/df_part_3_IC.csv"
path_df_part_3_UI = "./data/feature/df_part_3_UI.csv"
path_df_part_3_UC = "./data/feature/df_part_3_UC.csv"
...
# item_sub_set P
path_df_P = "./data/tianchi_fresh_comp_train_item.csv"

##### output file
path_df_result = "./data/lr/res_LR_k_means_subsample.csv"
path_df_result_tmp = "./data/lr/df_result_tmp.csv"
